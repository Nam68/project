...
public class AdDTO {
	...
	public AdDTO(int bbs_idx, int a_idx, String a_title, String a_content, String a_writer, int a_limit, String a_href,
			int a_count, Date a_startdate, Date a_enddate, String a_permit) {
		super();
