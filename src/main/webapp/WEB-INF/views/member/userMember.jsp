		...
		<article>
			...
			<form name="memberOk" method="post" action="memberOk.do">
				<ul class="ul">
					...
					<li><h4>생년월일 <strong>&#42;</strong></h4><input type="date" id="nick" name="age" ></li>
					<li><h4>성별 <strong>&#42;</strong></h4><input type="radio" id="nick" name="gender" value="1">남 <input type="radio" id="nick" name="gender" value="2">여</li>
					<li>
  						<h4>연락처 <strong>&#42;</strong></h4><input type="text" name="tel" id="tel">
  						<h6>' - ' 빼고 입력해 주세요 *</h6>
  					</li>
  					<li><h4>지역 <strong>&#42;</strong></h4><select name="c_idx">
<c:forEach var="ci" items="${city }">
<option value="${ci.c_idx }">${ci.city }</option>
</c:forEach>
</select></li>
...
<option value="${con.q_idx }">${con.q_content }</option>
				...
				<input type="hidden" name="groupidx" value="2">
