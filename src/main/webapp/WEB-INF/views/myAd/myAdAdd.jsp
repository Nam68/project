...
<head>
	...
	<script>
		...
		function adSubmit() {
			...
			sendXHRwithJSON('myAdSubmit.do', data, adSubmitResult);
		}
...
<body>
	<div class="adManagerTitle">
		<div>광고명</div>
		<div>
			<input class="adTitleText" type="text" id="adTitle">
		</div>
	</div>
	<div class="adImgAndContent">
		...
		<div>
			...
			<div class="othersDiv">
				<div>
					<div class="timeSetting" onclick="dateModalOn()">기간 설정 Click </div> <input type="hidden" id="startInfoHidden"><input type="hidden" id="endInfoHidden">
					<div class="budgetSetting" onclick="limitModalOn()">예산 설정</div>
					<div class="budgetView">예산미리보기</div>
				</div>
			</div>
		</div>
	</div>
